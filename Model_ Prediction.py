...
#### Basic EDA of Data
data=pd.read_excel(r"C:\360digitmg Project\New folder\Final_part\pro_71 (1).xlsx")
data.shape
data.columns
data.describe()
data.info()
...
df= df_new[['Maintenance_cost','Marketing_cost','Salary_of_the_trainer','Duration_of_coaching_in_Hours','Debentures','Mode_of_Class','Level_of_Course','Location']]
y = df_new.iloc[:, -1]
...
print(model.predict([[5000, 6000, 10000,120,3500,2,3,0]]))
